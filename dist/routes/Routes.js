...
class UsuarioRouter {
    ...
    routes() {
        ...
        this.router.post('/login/:login/:senha', usuarioController_1.default.validateToken); //  Valida token do usuário no login
        this.router.post('/teste/:teste', usuarioController_1.default.enviarDados);
    }
}
//  Exportação
