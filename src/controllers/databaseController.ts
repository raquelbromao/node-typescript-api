...
class DatabaseController {
    ...
    public async receiveFromMSSQLandInsertMONGO(req: Request, res: Response) {
        ...
        await mssql.getTableAndInsert('VW_CLIENTE_PALM', camposCliente, res);            
    }
}
